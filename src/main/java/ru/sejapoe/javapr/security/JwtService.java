package ru.sejapoe.javapr.security;
...
public class JwtService {
    ...
    public <T> T extractClaim(String token, String name, Class<T> requiredClass) {
        return jwtParser.parseSignedClaims(token).getPayload().get(name, requiredClass);
    }
}
